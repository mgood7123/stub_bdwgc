...
CFLAGS_EXTRA=
DEFINES=-D_WINDOWS -DMANAGED_STACK_ADDRESS_BOEHM_GC_DLL -DMANAGED_STACK_ADDRESS_BOEHM_GC_THREADS -DMANAGED_STACK_ADDRESS_BOEHM_GC_DISCOVER_TASK_THREADS \
    -DALL_INTERIOR_POINTERS -DENABLE_DISCLAIM -DMANAGED_STACK_ADDRESS_BOEHM_GC_ATOMIC_UNCOLLECTABLE \
    -DMANAGED_STACK_ADDRESS_BOEHM_GC_GCJ_SUPPORT -DJAVA_FINALIZATION -DNO_EXECUTE_PERMISSION \
    -DMANAGED_STACK_ADDRESS_BOEHM_GC_REQUIRE_WCSDUP -DUSE_MUNMAP
...
gc.def: digimars.mak
	...
	echo EXPORTS >>gc.def
	echo MANAGED_STACK_ADDRESS_BOEHM_GC_is_visible_print_proc >>gc.def
	echo MANAGED_STACK_ADDRESS_BOEHM_GC_is_valid_displacement_print_proc >>gc.def
